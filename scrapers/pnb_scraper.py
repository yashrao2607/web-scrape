...
class PNBScraper(BaseScraper):
    """
    Scraper implementation for Punjab National Bank (PNB).
    """
    async def scrape(self, page: Any) -> Dict[str, Any]:
        self.logger.info("starting_pnb_scrape")
        ...
        return {
            ...
            "premature_withdrawal_penalty": "1.00% penalty on premature withdrawal",
