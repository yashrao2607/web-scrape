...
class SouthIndianBankScraper(BaseScraper):
    """
    Scraper implementation for South Indian Bank.
    """
    async def scrape(self, page: Any) -> Dict[str, Any]:
        self.logger.info("starting_south_indian_bank_scrape")
        ...
        return {
            ...
            "premature_withdrawal_penalty": "0.50% to 1.00% premature withdrawal penalty",
